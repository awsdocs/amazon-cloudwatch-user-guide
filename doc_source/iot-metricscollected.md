...
| --- | --- | 
| ActionType |  The [action type](https://docs.aws.amazon.com/iot/latest/developerguide/iot-rule-actions.html) specified by the rule that triggered by the request\.  | 
