...
|  **Element ID** |  String  |  If the element that generated the event has an ID, this property stores that ID\. For more information, see [Element\.id](https://developer.mozilla.org/en-US/docs/Web/API/Element/id)\. Otherwise, this property stores the tag name\. For more information, see [Element\.tagName](https://developer.mozilla.org/en-US/docs/Web/API/Element/tagName)\.  | 
