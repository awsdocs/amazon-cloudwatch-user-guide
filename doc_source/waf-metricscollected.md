...
AWS WAF sends data to CloudWatch every minute\. For more information, see [Testing Web ACLs](https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-testing.html) in the *AWS WAF Developer Guide*\.
