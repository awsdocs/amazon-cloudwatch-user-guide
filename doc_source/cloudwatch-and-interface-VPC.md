...
To start using CloudWatch with your VPC, create an interface VPC endpoint for CloudWatch\. For more information, see [Creating an Interface Endpoint](http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/vpce-interface.html#create-interface-endpoint.html) in the *Amazon VPC User Guide*\.
