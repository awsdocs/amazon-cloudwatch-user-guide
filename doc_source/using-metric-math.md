...
1. For the **Details** column, enter the math expression\. The tables in the following section list the functions that you can use in the expression\.
