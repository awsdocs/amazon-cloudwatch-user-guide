# Amazon CloudWatch Resources<a name="RelatedResources"></a>
...
|   [Release notes](http://aws.amazon.com/releasenotes/CloudWatch)   |   The release notes give a high\-level overview of the current release\. They specifically note any new features, corrections, and known issues\.   | 
|   [AWS Developer Resource Center](http://aws.amazon.com)   |   A central starting point to find documentation, code examples, release notes, and other information to help you build innovative applications with AWS\.   | 
