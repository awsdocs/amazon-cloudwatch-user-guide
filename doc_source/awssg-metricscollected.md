...
| CloudDownloadLatency |  The total number of milliseconds spent reading data from AWS during the reporting period\. Use this metric with the `Average` statistic to measure latency\. Units: Milliseconds  |  Cached volumes, Stored volumes and Tape\.  | 
